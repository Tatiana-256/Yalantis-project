...
export const CountQuality: React.FC<IProps> = ({itemQuantity, decrement, increment, product, buttonSize, width}) => {
    ...
    return <>
        <Count width={`${width}%`}>
            <Button width={`${buttonSize}px`} height={`${buttonSize}px`}
                    onClick={() => {
        ...
        <Button height={"50px"} width={"70%"} onClick={addItem}>Add to basket</Button>
    </>
}
