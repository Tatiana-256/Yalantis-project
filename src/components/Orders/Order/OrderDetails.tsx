...
import { IOrder, showDetails } from "../../../state/redux/slices/ordersSlice";
import { selectOrder } from "../../../state/redux/state-selectors";
import { DetailWrap, OrderWrap } from "./OrderDetails-style";
import { Date } from "../../../common-components/convertDate/Date";
import { TotalWrap } from "../../Bag/Bag-styles";
